# sqa26A
Ini adalah repo kelas 3A matkul Software Quality
...
PDF terlampir dapat ditemukan di sini [dokumen test plan](https://github.com/kerjabhakti/sqa26B/blob/main/TugasSelenium/Test_Plan_Sample.pdf) untuk diunduh.
